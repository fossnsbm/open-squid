...
export default function LiveQuizPage() {
  ...
  <div className="max-w-4xl mx-auto px-4">
          ...
          {currentUser && (
            <div className="text-sm text-gray-300">
              ...
              <span className="font-bold text-pink-300">
                {participants.find((p) => p.user_id === currentUser.id)?.score || 0}
              </span>
            </div>
          )} */}

          {currentSession?.status === "live" && !isJoined && currentUser && (
            <button
              onClick={joinQuiz}
      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-300">Quiz Status:</span>
            <span
    ...
    <div className="bg-gray-800 rounded-lg border border-gray-600 shadow-sm">
      ...
      <div className="p-6">
        {/* Waiting State */}
        {!currentSession?.status || currentSession?.status === "pending" && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4">
              The admin will start the quiz shortly. Make sure you've selected your profile above.
            </p>
        ...
        {currentSession?.status === "live" && currentQuestion && (
          <div className="space-y-6">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div
                className={`h-2 rounded-full transition-all duration-1000 ${
                  timeLeft <= 3 ? "bg-red-500" : "bg-pink-600"
                }`}
                style={{
                  width: `${
                    (((currentSession.timePerQuestion || 10) - timeLeft) /
                      (currentSession.timePerQuestion || 10)) *
                    100
                  }%`,
                }}
              />
            ...
            <button
              onClick={() =>
                selectedAnswer !== null && submitAnswer(selectedAnswer)
              }
              disabled={selectedAnswer === null || hasAnswered || !isJoined}
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4">
              ...
              <strong className="text-2xl text-pink-300">
                {participants.find((p) => p.user_id === currentUser?.id)?.score || 0} points
              </strong>
            </p>
            <div className="bg-gray-700 border border-gray-600 rounded-lg p-4 max-w-md mx-auto mb-4">
              <p className="text-sm text-gray-300">
                Questions answered:{" "}
                {participants.find((p) => p.user_id === currentUser?.id)?.total_questions_answered || 0}
                /{questions.length}
              </p>
            </div>
            <button
        ...
        {currentSession?.status === "live" && !currentQuestion && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4">
              There seems to be an issue loading the current question.
            </p>
            <button
